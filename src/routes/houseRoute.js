...
houseRouter
    .route('/category')
    .get(housesController.getAllCategory);
...
houseRouter
    ...
    .patch(protectRoute, isHouseOwner({ admin: true }), housesController.updateHouse)
    .delete(protectRoute, isHouseOwner({ admin: true }), housesController.deleteHouse)
